...
typedef struct{
		...
		uint_8  Pres_select;			//æ¨¡å¼æ°´åŽ‹é€‰æ‹©æ ‡å¿—ä½
		uint_8  PG_gear;				//å–·æ†ä½ç½®å¾®è°ƒ
		uint_8  Water_gear;				//sæ°´åŽ‹å¾®è°ƒ
		uint_8	ZuoYu_f:1;			//-----×ùÔ¡		
		...
		uint_8	test_f:1;
		uint_8	PcbTest_f:1;
		NvXing_uion Woem;      //  2019-7-19 æŠŠç›¸åº”çš„æ¨¡å¼ç»“æž„ä½“æ”¾å…¥è¿™é‡Œï¼Œç»Ÿä¸€ç”¨è¿™ä¸ªç»“æž„ä½“è®¿é—®
		TunBu_uion  Hip;
