...
/******************************
//	温度档位图标显示操作
//水温3档是buff[0] 底灯是buff[2]  2档是 buff[4]  1档是buff[6] (硬件无法更改)
//座温3档 buff[12] 底灯buff[14] 2档 buff[10]  1档buff[8]
******************************/
void Water_Gear_display(uint_8 num)    //有问题！！！！7/24      显示  超过3就死机
{
	uint_8 i = 0;
	TM1629B.DisFlag = 1;
	switch(num)
	{
		...
		break;
		//水温1档
		case 1:	TM1629B.DisBuf[6] |= 0x01 << 0;
		break;
		//水温2档
		case 2:	TM1629B.DisBuf[6] |= 0x01 << 0;
				TM1629B.DisBuf[4] |= 0x01 << 0;
		break;
		//水温3档
		case 3:	TM1629B.DisBuf[6] |= 0x01 << 0;
				TM1629B.DisBuf[4] |= 0x01 << 0;
				TM1629B.DisBuf[0] |= 0x01 << 0;
		break;
		//水温3档+底灯
		case 4:	TM1629B.DisBuf[6] |= 0x01 << 0;
				TM1629B.DisBuf[4] |= 0x01 << 0;
				TM1629B.DisBuf[0] |= 0x01 << 0;
				TM1629B.DisBuf[2] |= 0x01 << 0;
		break;
	}
}
...
/*	Water_Gear_display(S->Icon.water_gear);  //显示水温档位
	Seat_Gear_display(S->Icon.set_gear);     //显示座温档位
	Energy_Icon(S->Icon.elec_icon);      //节能图标
	Power_Icon(S->Icon.power_icon);   //电源图标*/
}
