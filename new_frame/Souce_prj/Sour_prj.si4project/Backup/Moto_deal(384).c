...
{2025,2150,2345,2440,2680,2790},					//臀部清洗喷杆位置 0归位 1,2,3,4,5档             {2000,2050,2050,2100,2280,2360},
{750,600,480,350,225,0},							//女性清洗喷杆位置 0归位 1,2,3,4,5档  
...
{	
	...
	Dis_temp = Slet_position(t->select, p->Work_index-1, 5, p->Auto_clear);	            //设定往复运动的目标位置
